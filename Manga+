...
<body>
    ...
    <div class="premium-banner" id="premiumBanner">
        <p>🔓 <strong>Premium</strong> unlocks ALL manga + 50+ exclusive series</p>
        <a href="https://rzp.io/rzp/5DiyqYn" target="_blank" class="btn-premium" id="upgradeBtn">
            ⭐ Go Premium — ₹99/mo
        </a>
    </div>
    ...
    <script>
        ...
        //  🧠 STATE
        // ────────────────────────────────────────────────────────
        // Check if user is premium (stored in localStorage)
                ...
                el.addEventListener('click', () => {
                    ...
                    if (manga) {
                        if (manga.premium && !isPremium) {
                            showToast('🔒 Premium manga. Subscribe to unlock!');
                            return;
                        }
                        openReader(manga);
                    }
        ...
        function updatePremiumUI() {
            ...
            // Re-render grid to update locks
            filterManga();
        }

        // ────────────────────────────────────────────────────────
        //  🔓 SIMULATE PREMIUM (For testing after payment)
        // ────────────────────────────────────────────────────────
        ...
        // Check URL params for premium activation (for testing)
        const urlParams = new URLSearchParams(window.location.search);
        if (urlParams.get('premium') === 'true') {
            activatePremium();
        }

        // Also listen for postMessage (if opened from Razorpay)
        ...
        console.log('🔗 Payment Link: https://rzp.io/rzp/5DiyqYn');
